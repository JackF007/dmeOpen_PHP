          ...
          <div class="panel-body">
              <form  method="post"  enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="cat_id" value="<?php echo $subcategory_data['category_id']; ?>">
                        <label for="exampleInputEmail1">Name</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="sub_category_name" placeholder="Enter Category name" value="<?php echo $subcategory_data['sub_category_name']; ?>">
