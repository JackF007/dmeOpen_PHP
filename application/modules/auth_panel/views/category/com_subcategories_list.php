    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="adv-table">
                ...
                <!-- <a class="btn-xs bold  btn btn-info pull-right" href="<?php //echo AUTH_PANEL_URL . 'Category/create_category/'.$id.'/'.$category_id; ?>">Add New</a> -->
               ...
               <script type="text/javascript" language="javascript" >
                   ...
                   jQuery(document).ready(function() {
                       ...
                       var dataTable = jQuery("#"+table).DataTable( {
                           ...
                           "ajax":{
                               url :"$adminurl"+"Category/ajax_comm_subcategories/$root_id/$category_id", // json datasource
