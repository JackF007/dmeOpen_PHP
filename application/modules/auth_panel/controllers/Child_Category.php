...
class Child_Subcategory extends MX_Controller {
...
//================================ AJAX FOR Subcategory LIST=======================================//
    ...
    public function ajax_subcategory_list() 
    {
		...
		{  
			...
			$action = "<a class='btn-xs bold  btn btn-info' href='" . AUTH_PANEL_URL . "Subcategory/edit_subcategory/" . $r->sub_category_id ."/". $r->category_id. "'>Edit</a>&nbsp;"
...
//=================================== EDIT Subcategory ==========================================//     
	...
	public function edit_subcategory($id = null ,$cat_id) 
	{
		...
		else 
		{
			...
			{	
				...
				else 
				{
					...
					$update_data = $this->Subcategory_Model->update_subcategory($id,$cat_id);
					if ($update_data == true) 
					{
