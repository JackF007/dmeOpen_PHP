...
class Ajax_pagination {
    ...
    var $last_link = 'Last';
    var $uri_segment = 4;
            var$full_tag_open = "<div class='pagination text-center'><ul class='pagination'>";
    var $full_tag_close = "</ul></div>";
    var $num_tag_open = '<li>';
    var $num_tag_close = '</li>';
    var $cur_tag_open = "<li class='disabled'><li class='page-item active'><a href='#'>";
    ...
    function create_links() {
        ...
        $output = $output1 . $this->full_tag_open . $output . $this->full_tag_close;
        ?>
        <script>
