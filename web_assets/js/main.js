;(function () {
	...
	// btn-animation for poduct 
	$("#filter-btn").on("click", function(){
		$("#filterclass").toggleClass("mobile-dis-none");
	});

	// offers timer
	var timerlocation = document.getElementById("offer-timer");
    ...
    var x = setInterval(function() {
		...
		timerlocation.innerHTML = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
		if (distance < 0) {
			clearInterval(x);
			timerlocation.innerHTML = "EXPIRED";
		}
	}, 1000);
